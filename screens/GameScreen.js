...
const GameScreen = ({ userNumber, onGameOver }) => {
  ...
  const guessRounsListLength = guessRounds.length

  return (
    <View style={styles.screen}>
      <Title>A vez do oponente</Title>
      ...
      <View style={styles.listContainer}>
        ...
        <FlatList
          data={guessRounds}
          renderItem={(itemData) => <GuessLogItem roundNumber={guessRounsListLength - itemData.index} guess={itemData.item} />}
